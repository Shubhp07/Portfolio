...
const skillsSection = {
  ...
  skills: [
    ...
    emoji("⚡ Building Progressive Web Applications using both traditional multi-page and Single Page Application (SPA) architectures."),
    emoji(
  ...
  projects: [
    ...
    },
    {
      ...
      footerLink: [
        {
          name: "Visit Website",
          url: "https://github.com/Shubhp07/newsmonkey"
        }
      ]
    }
  ],
  ...
  achievementsCards: [
    {
      ...
      subtitle: "Certified in Java (Basic) – HackerRank Verified",
    ...
    },
    {
      ...
      subtitle:
        "Completed Masterclass on Git & GitHub – PhysicsWallah.",
...

    {
      ...
      subtitle: "JavaScript Programming Essentials – Udemy",
